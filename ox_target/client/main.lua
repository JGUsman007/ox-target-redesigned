...
local function oxtargetwheelinput(dir)
    SendNUIMessage({
        type = 'input',
        key = dir
    })
...
CreateThread( function ()
                ...
                while state.isActive() do
                    ...
                    if state.optionscreated() then
                        ...
                        if IsDisabledControlJustPressed(0, 15) then
                            oxtargetwheelinput('up')
                        end

                        if IsDisabledControlJustPressed(0, 14) then
                            oxtargetwheelinput('down')
                        end
                    end
 ...
 do
    ...
    -- lib.addKeybind({
    --     name = 'ox:target:scrollup',
    --     description = 'target system scroll input',
